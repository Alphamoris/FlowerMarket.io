        ...
        const fetchPrices = async () => {
            try {
                ...
                if (priceDetails == "Unauthorized") {
                    ...
                    const filteredArray : PriceDetail[] = priceDetails.filter((value: any) => value.availability >= 10)
                    for (let i = 0; i < filteredArray.length; i += 2) {
                        pairs.push({
                            detail1: filteredArray[i],
                            detail2: filteredArray[i + 1] || null
                        });
                    }
                    setPricePairs(pairs);
                }
