...
export default function Service() {
  return (
    ...
    <>
      ...
      <section className="bg-light py-5 py-xl-8 border border-bottom-5 border-black servicesclr">
        <div className="container">
          <div className="row justify-content-md-center">
            <div className="col-12 col-md-10 col-lg-8 col-xl-7">
              <h3 className="fs-6 mb-2 text-secondary text-center text-uppercase">What We Do?</h3>
              <h2 className="display-5 mb-5 text-center">We connect flower markets located in the nook and corner of the cities , which will let you choose between markets , by resting at home</h2>
            ...
            <div className="col-12 col-sm-6 col-xl-3">
              <div className="card border-0 border-bottom border-primary shadow-sm">
                <div className="card-body text-center p-4 p-xxl-5">
                  ...
                  <h4 className="mb-4">Exploration</h4>
                  <p className="mb-4 text-secondary">We can help you to identify a variety of markets which has a vast collection of flowers and you may also find best deals than your local flower market.</p>
                  <Link href="#!" className="fw-bold text-decoration-none link-primary">
                    Learn More
            ...
            <div className="col-12 col-sm-6 col-xl-3">
              <div className="card border-0 border-bottom border-primary shadow-sm">
                <div className="card-body text-center p-4 p-xxl-5">
                  ...
                  <h4 className="mb-4">Transportation</h4>
                  <p className="mb-4 text-secondary">We tie up with a huge community of drivers and deliver the flowers quickly and we also offer <strong>Free Delivery</strong> for orders over <i className="bi bi-currency-rupee"></i>299 /-.</p>
                  <Link href="#!" className="fw-bold text-decoration-none link-primary">
                    Learn More
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrow-right-short" viewBox="0 0 16 16">
                      <path fillRule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z" />
              ...
              <div className="card border-0 border-bottom border-primary shadow-sm">
                <div className="card-body text-center p-4 p-xxl-5">
                  <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" fill="currentColor" className="bi bi-heart-pulse text-primary mb-4" viewBox="0 0 16 16">
                    ...
                    <path fillRule="evenodd" d="M10.464 3.314a.5.5 0 0 0-.945.049L7.921 8.956 6.464 5.314a.5.5 0 0 0-.88-.091L3.732 8H.5a.5.5 0 0 0 0 1H4a.5.5 0 0 0 .416-.223l1.473-2.209 1.647 4.118a.5.5 0 0 0 .945-.049l1.598-5.593 1.457 3.642A.5.5 0 0 0 12 9h3.5a.5.5 0 0 0 0-1h-3.162l-1.874-4.686Z" />
                  </svg>
                  <h4 className="mb-4">Quality Assurance</h4>
                  <p className="mb-4 text-secondary">No compromise in quality , all flowers as fresh as they are in plants. Neat packing , refraining the flowers from damage</p>
                  <Link href="#!" className="fw-bold text-decoration-none link-primary">
                    Learn More
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrow-right-short" viewBox="0 0 16 16">
                      <path fillRule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z" />
              ...
              <div className="card border-0 border-bottom border-primary shadow-sm">
                <div className="card-body text-center p-4 p-xxl-5">
                  <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" fill="currentColor" className="bi bi-mouse text-primary mb-4" viewBox="0 0 16 16">
                    <path fillRule="evenodd" d="M8 3a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 8 3zm4 8a4 4 0 0 1-8 0V5a4 4 0 1 1 8 0v6zM8 0a5 5 0 0 0-5 5v6a5 5 0 0 0 10 0V5a5 5 0 0 0-5-5z" />
                  </svg>
                  ...
                  <Link href="help/contactus" className="fw-bold text-decoration-none link-primary">
                    Learn More
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrow-right-short" viewBox="0 0 16 16">
                      <path fillRule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z" />
                    </svg>
